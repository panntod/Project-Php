...
<div class="container" style="min-height: 100vh; padding-top: 5rem;">
    ...
    <div class="row justify-content-evenly">
        <div class="col-lg-4 col-12">
            <img src="foto_produk/<?= $dt_buku['foto'] ?>" class="card-img-top rounded shadow" style="height: 240px">
        </div>
            ...
            <form action="masukan_keranjang.php?id_buku=<?= $dt_buku['id_buku'] ?>" method="post">
                <table class="table table-hover table-striped border shadow">
                    <thead>
                        ...
                        <tr>
                            <td colspan="2"><input class="btn btn-success w-50" type="submit" style="margin-left: 20%;" value="PINJAM"></td>
                        </tr>
                    </thead>
                </table>
            </form>
