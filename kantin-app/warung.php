        ...
        <div class="row gy-4 portfolio-container">
          ...
          while ($dt_menu_makanan = mysqli_fetch_array($qry_menu)) {
            ...
            <div class="portfolio-wrap">
              <a href="#" data-gallery="portfolio-gallery-app" class="glightbox"><img src="<?= $dt_menu_makanan['gambar'] ?>" class="img-fluid" alt=""></a>
              <div class="portfolio-info">
                <h4><a href="#" title="More Details"><?= $dt_menu_makanan['nama_menu'] ?></a></h4>
                <p><?= $dt_menu_makanan['deskripsi_menu'] ?></p>
